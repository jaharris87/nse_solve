...
! Self-heating Controls
  Integer :: itemp        ! If >0, then implicitly couple network to temperature (self-heating)
...
Integer  :: lun_timer
Real(8)  :: timer_nsesolv = 0.0
Real(8)  :: timer_nsenrap = 0.0
Real(8)  :: timer_nseeval = 0.0
Real(8)  :: timer_nsescrn = 0.0

!$OMP THREADPRIVATE(lun_timer,timer_nsesolv,timer_nsenrap,timer_nseeval,timer_nsescrn)
